...
namespace EF_Project.Migrations
{
    ...
    [Migration("20250220203552_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EF_Project.Entities.Course_Instructor", b =>
                {
                    b.HasOne("EF_Project.Entities.Course", "Course")
                        .WithMany("TeachedBy")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EF_Project.Entities.Instructor", "Instructor")
                        .WithMany("Teach")
            ...
            modelBuilder.Entity("EF_Project.Entities.Instructor", b =>
                {
                    b.HasOne("EF_Project.Entities.Department", "Department")
                        .WithOne("Instructor")
                        .HasForeignKey("EF_Project.Entities.Instructor", "DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EF_Project.Entities.Student_Course", b =>
                {
                    ...
                    b.HasOne("EF_Project.Entities.Student", "Student")
                        .WithMany("Courses")
